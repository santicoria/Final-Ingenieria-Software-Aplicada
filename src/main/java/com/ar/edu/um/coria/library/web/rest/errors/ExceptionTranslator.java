package com.ar.edu.um.coria.library.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.ar.edu.um.coria.library.service.EmailAlreadyUsedException ||
            ex instanceof com.ar.edu.um.coria.library.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.ar.edu.um.coria.library.service.InvalidPasswordException
