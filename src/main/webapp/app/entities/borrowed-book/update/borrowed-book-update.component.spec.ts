...
describe('BorrowedBook Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call book query and add missing value', () => {
      ...
      const book: IBook = { id: 12876 };
      borrowedBook.book = book;

      const bookCollection: IBook[] = [{ id: 29599 }];
    ...
    it('Should call client query and add missing value', () => {
      const borrowedBook: IBorrowedBook = { id: 456 };
      const client: IClient = { id: 24189 };
      borrowedBook.client = client;

      const clientCollection: IClient[] = [{ id: 7196 }];
    ...
    it('Should update editForm', () => {
      const borrowedBook: IBorrowedBook = { id: 456 };
      const book: IBook = { id: 29973 };
      borrowedBook.book = book;
      const client: IClient = { id: 13793 };
      borrowedBook.client = client;
